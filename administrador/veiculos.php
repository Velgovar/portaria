    ...
    <head>
        ...
        <body>
            <div class="setor-container">
                ...
                <form id="vigia-form" method="POST" action="config/veiculos_config.php">
                    <div class="form-group">
                    <div class="form-group">
                    <h2>Cadastrar Veiculos</h2>
                        <input type="text" id="nome" name="nome" placeholder="Digite o nome do Veiculo" required>
            ...
            <table>
                <thead>
                    ...
                    <?php
                        ...
                        $sql = "SELECT id, nome FROM veiculos ORDER BY id DESC";
                    ...
                    echo '<tr><td colspan="2">Nenhum Veiculo cadastrado.</td></tr>';
                        }
