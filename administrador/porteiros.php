...
<html lang="pt-BR">
    <head>
        ...
        <title>Cadastrar Porteiros</title>
        <link rel="stylesheet" href="css/porteiros.css">
    </head>
        <body>
            <div class="setor-container">
                <div class="fixed-container">
                <form id="vigia-form" method="POST" action="config/porteiros_config.php">
            ...
            <div class="table-container">
                <div class="table-header">
                    <h2>Lista de Porteiros Cadastrados</h2>
                    <thead>
                </div>
        ...
        <script src="js/porteiros.js"></script>
